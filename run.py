...
if __name__ == "__main__":
    ...
    # noqa: python run.py --year 2017 --processor vjetsnlo --pfnano v2_2 --n 1 --starti 0 --local --channels mu,ele --config samples_inclusive.yaml --executor iterative --sample WJetsToLNu_012JetsNLO_34JetsLO_EWNLOcorr 
